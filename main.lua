...
function love.keypressed(key)
    ...
    -- checks for the number keys pressed for the game options
    elseif key == '1' then
        options = '1'
        gameState = 'serve'
    elseif key == '2' then
...
function love.draw()
    ...
    elseif gameState == 'options' then
        -- UI messages
        love.graphics.printf('Please Select a Play Option', 0, 10, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('(1.) 2 Player (2.) Play a Bot', 0, 20, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)
